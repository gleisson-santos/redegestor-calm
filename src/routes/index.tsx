      ...
      <div className="px-4 lg:px-8 py-6">
        <header className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-6 pb-5 border-b border-border">
          <div>
            ...
            <h1 className="text-2xl font-semibold tracking-tight"><span className="text-[oklch(0.55_0.13_155)]">Consolidação</span><span className="text-foreground"> de Frentes de Serviço</span></h1>
